...
- отправка `.ics`-файла для Outlook, Google Calendar и Apple Calendar после создания бронирования;
...
Проверить формирование календарного `.ics`-файла:

```powershell
python scripts/check_calendar_invite.py
```
